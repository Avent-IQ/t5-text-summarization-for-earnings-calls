# Text-to-Text Transfer Transformer Quantized Model for Earnings Calls Text Summarization
...
- **Task:** Earnings Calls Text Summarization  
...
model_name = "AventIQ-AI/t5-text-summarization-for-earnings-calls"
